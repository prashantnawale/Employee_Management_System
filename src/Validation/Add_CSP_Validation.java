...
/**
 * Servlet implementation class Add_CSP_Validation
 */
@WebServlet("/Add_CSP_Validation")
public class Add_CSP_Validation extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String JKM_Account_No= request.getParameter("JKM_Account_No");
		 ...
		 try {
			...
			PreparedStatement pst = con.prepareStatement("insert into cspdetail1 "
  ...
  
  {
	  response.sendRedirect("CSP.jsp");
        ...
        System.out.println("Add CSP detail Successfully");
        
        System.out.println("Add CSP Detail Successfully?msg=  "+first_name+"  "+last_name+"  "+middel_name+" ");

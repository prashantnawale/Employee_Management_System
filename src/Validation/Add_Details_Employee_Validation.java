...
/**
 * Servlet implementation class Add_Details_Employee_Validation
 */
@WebServlet("/Add_Details_Employee_Validation")
public class Add_Details_Employee_Validation extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String JKM_Account_No= request.getParameter("JKM_Account_No");
		 ...
		 try {
 			...
 			PreparedStatement pst = con.prepareStatement("insert into employeedetail1 "
...
/*		HttpSession session=request.getSession();
		  ...
		  session.setAttribute("middel_name",middel_name);
  ...
  
  {
	  response.sendRedirect("Employee.jsp");
        ...
        System.out.println("Add Detail Successfully?msg="+first_name+"  "+last_name+"   "+middel_name+"");

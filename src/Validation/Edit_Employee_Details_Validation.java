...
/**
 * Servlet implementation class Edit_Employee_Details_Validation
 */
@WebServlet("/Edit_Employee_Details_Validation")
public class Edit_Employee_Details_Validation extends HttpServlet {
	...
	//	 System.out.println("entry :+i");
		 ...
		 System.out.println("Edit Employee detail successfully"+first_name  +last_name  +middel_name);
  {

...
/**
 * Servlet implementation class CSP_Extra_Detail_Validation
 */
@WebServlet("/CSP_Extra_Detail_Validation")
public class CSP_Extra_Detail_Validation extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stubPrintWriter pw=response.getWriter();
		...
		try {
			...
			Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "system","prashant");
 			...
 			PreparedStatement pst = con.prepareStatement("insert into CSP_Extra_Detail1"
 			...
 			int i=pst.executeUpdate();
 			 ...
 			 {
 				  response.sendRedirect("Search_CSP_Extra_Detail.jsp");
 			  }

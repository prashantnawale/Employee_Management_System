...
/**
 * Servlet implementation class Agent_Extra_Detail_Validation
 */
@WebServlet("/Agent_Extra_Detail_Validation")
public class Agent_Extra_Detail_Validation extends HttpServlet {
	...
	PrintWriter pw=response.getWriter();
		...
		try {
			...
			Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "system","prashant");
 			...
 			PreparedStatement pst = con.prepareStatement("insert into Agent_Extra_Detail1"
 			...
 			*/
 			...
 			int i=pst.executeUpdate();
 			 ...
 			 {
 				  response.sendRedirect("Search_Agent_Extra_Detail.jsp");
 			  }
 			 
 					
 			 System.out.println("Add Extra Detail Successfully?msg=  "+Agent_Id+"  "+First_name+"  "+Middel_name+"   "+Last_name+"  ");

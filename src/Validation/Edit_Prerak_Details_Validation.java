...
/**
 * Servlet implementation class Edit_Prerak_Details_Validation
 */
@WebServlet("/Edit_Prerak_Details_Validation")
public class Edit_Prerak_Details_Validation extends HttpServlet {
...
PrintWriter pw=response.getWriter();
	...
	//	 System.out.println("entry :+i");
		 System.out.println("Edit Prerak detail successfully"+first_name  +last_name  +middel_name);
  {

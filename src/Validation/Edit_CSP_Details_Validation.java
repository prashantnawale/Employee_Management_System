...
/**
 * Servlet implementation class Edit_CSP_Details_Validation
 */
@WebServlet("/Edit_CSP_Details_Validation")
public class Edit_CSP_Details_Validation extends HttpServlet {
...
PrintWriter pw=response.getWriter();
	...
	//	 System.out.println("entry :+i");
		 ...
		 System.out.println("Edit CSP detail successfully"+first_name  +last_name  +middel_name);
  {

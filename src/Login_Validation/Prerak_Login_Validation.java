...
/**
 * Servlet implementation class Prerak_Login_Validation
 */
@WebServlet("/Prerak_Login_Validation")
public class Prerak_Login_Validation extends HttpServlet {
...
PrintWriter pw=response.getWriter();
		...
		String password = request.getParameter("password");
		  ...
		  try {
	     	...
	     	ResultSet rs = stmt.executeQuery("select * from preraklogin where username='"+uname+"' and password='"+password+"'");
			...
			//	if("username".equals(uname) && "password".equals(password))
					...
					response.sendRedirect("Prerak.jsp?msg="+uname+"");
			...
			System.out.println("Login In Prerak successfully?msg="+uname+"");

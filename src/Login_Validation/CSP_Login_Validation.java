...
/**
 * Servlet implementation class CSP_Login_Validation
 */
@WebServlet("/CSP_Login_Validation")
public class CSP_Login_Validation extends HttpServlet {
...
PrintWriter pw=response.getWriter();
		...
		String password = request.getParameter("password");
		  ...
		  try {
	     	...
	     	ResultSet rs = stmt.executeQuery("select * from CSPlogin where username='"+uname+"' and password='"+password+"'");
			...
			//	if("username".equals(uname) && "password".equals(password))
					...
					response.sendRedirect("CSP.jsp?msg="+uname+"");
			...
			System.out.println("Login In CSP successfully?msg="+uname+"");

...
<title>Prerak Personal Information</title>
</head>
<body style="color:black;">
	<form action="Add_Details_Prerak_Validation" method="post" >
	<br>
	<center>
		<h3 style="color: black;">Add Prerak </h3>
	</center>

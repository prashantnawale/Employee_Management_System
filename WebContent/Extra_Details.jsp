...
<title>Extra Details of Employee</title>
...
<body style="color:black;">
	<form action="Extra_Detail_Validation" method="post" >
	<center>
			<br>
	
		<h1 style="color: blue;">Extra Details of Employee </h1>
		
	</center>
	&nbsp;&nbsp;&nbsp;<a href='Search_Employee_Extra_Detail.jsp'>Show Detail</a> 
	
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	
	<a href='Search_All_Employee_Extra_Detail'>All Employee Extra Detail</a>
	<hr>
	...
	<%-- 		
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			 ...
			 JKM Account No:
				...
				<input type="text" placeholder=JKM_Account_No name="JKM_Account_No" required>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	--%>	
	       ...
	       <h5>
			...
			Joining Place:
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="text" palceholder=Joining_Place  name="Joining_Place" required>
			
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Joining Date:
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="text" palceholder=Joining_Date  name="Joining_Date" required>     <br>
			
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			
			Position:
			   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="text" palceholder=Position  name="Position" required>
			...
			Payment:
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="text" palceholder=Payment  name="Payment" required>

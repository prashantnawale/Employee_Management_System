...
<title>Prerak Extra Detail</title>
...
<body style="color:black;">
	<form action="Prerak_Extra_Detail_Validation" method="post" >
	<center>
	<br>
		<h1 style="color: blue;">Extra Details of Prarak </h1>
		
	</center>
	
	&nbsp;&nbsp;&nbsp;
	
	<a href='Search_Prerak_Extra_Detail.jsp'>Show Detail</a> 
	
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		
		<a href='Search_All_Prerak_Extra_Detail'>All Prerak Extra Detail</a>
	<hr>

...
<title>Add Pigmy Agent Detail</title>
...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Pigmy Agent Personal Information</title>
</head>
<body style="color:black;">
	<form action="Add_Details_Agent_validation" method="post" >
	<br>
	<center>
		<h3 style="color: black;">Add Employee </h3>
	</center>
